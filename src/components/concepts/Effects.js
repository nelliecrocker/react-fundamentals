        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up timers using memory, listeners to outside API's, and other functions which may use systems resources</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
...
const SampleEffect = () => {
    ...
    useEffect(() => {
        console.log('this paining needs some happy trees')}, [])
